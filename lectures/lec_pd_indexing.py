...
#Exercise2 return in a DataFrame
x1=pd.DataFrame(df.loc[['b', 'd', 'f', 'j'], 'col1'],columns=['col1'])
print(x1)
...
# df1=df.iloc[[i%2==1 for i in range(0,20)],[1]]
